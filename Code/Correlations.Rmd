...
```{r}
track.a.scaled <- cbind(track.a[1:2], scale(track.a[3:ncol(track.a)])) # add meta-information columns again
track.b.scaled <- cbind(track.b[1:2], scale(track.b[3:ncol(track.b)])) # add meta-information columns again
```
