...
correlogram.TrackB <- ggcorrplot(cor.results.b$r, p.mat = cor.results.b$p, type = "lower",
  ...
  geom_segment(aes(x = 10.5, y = 11.5, xend = 21.5, yend = 11.5)) 
correlogram.TrackB
```
...
cor.results.b.IE <- corr.test(track.b.short.IE.reorder, method = "spearman", 
                         use = "pairwise.complete.obs", adjust = "holm")
# produce correlogram
correlogram.TrackB.IE <- ggcorrplot(cor.results.b.IE$r, p.mat = cor.results.b.IE$p, type = "lower",
     outline.col = "white", colors = c("#3C77AE", "white", "#AE3C3C"),
...
cor.results.b.nonIE <- corr.test(track.b.short.nonIE.reorder, method = "spearman", 
                         use = "pairwise.complete.obs", adjust = "holm")
# produce correlogram
correlogram.TrackB.nonIE <- ggcorrplot(cor.results.b.nonIE$r, p.mat = cor.results.b.nonIE$p, type = "lower",
     outline.col = "white", colors = c("#3C77AE", "white", "#AE3C3C"),
